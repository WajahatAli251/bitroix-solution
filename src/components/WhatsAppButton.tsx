...
const WhatsAppButton = memo(() => {
  const phoneNumber = '923352222578'; // Pakistan WhatsApp business number
  const whatsappUrl = `https://wa.me/${phoneNumber}?text=Hi%20Bitroix%20Solution!%20I'm%20interested%20in%20your%20services.`;
